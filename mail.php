			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>Get in touch</h3>
						<p>We’d love to hear from you! Whether you have a question, need assistance, or just want to share feedback, our team is here to help. You can reach us easily by filling out the contact form below with your name, email, and message, and we’ll get back to you as soon as possible. </p>
					</div>
